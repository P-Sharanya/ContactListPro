...
I created ths iOS project using SwiftUI and follows the VIPER architecture pattern for the Contact List. The app uses UserDefaults for local storage to save and retrieve contact details persistently. This structure keeps logic centralized, improves testability, and makes the flow modular and easy to maintain.
